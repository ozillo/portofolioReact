...
const Home = () => {
  ...
  return (
    ...
    <>
     ...
     {/* <img className="imgPerfil" src="https://res.cloudinary.com/dw9b8eqmc/image/upload/v1709227532/PortofolioMarcMateo/Blanc_i_negre_1_en_taman%CC%83o_mediano_twux4c.png"alt="imgCard"/> */}
